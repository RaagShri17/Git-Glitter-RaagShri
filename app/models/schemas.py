...
class ConfidenceMatrixOut(BaseModel):
    topic_id: str
    topic_name: Optional[str] = None
    quadrant: str  # "danger_zone" | "hidden_strength" | "well_calibrated" | "correctly_flagged"
    gap: float
    message: str
...
class QuizResultOut(BaseModel):
    ...
    score_pct: float
    error_tags: List[str]
    confidence_matrix: Optional[ConfidenceMatrixOut] = None
...
# ---------- Confidence Matrix (dashboard view, all topics at once) ----------
class ConfidenceMatrixSummaryOut(BaseModel):
    danger_zone: List[ConfidenceMatrixOut] = []
    hidden_strength: List[ConfidenceMatrixOut] = []
    well_calibrated: List[ConfidenceMatrixOut] = []
    correctly_flagged: List[ConfidenceMatrixOut] = []
